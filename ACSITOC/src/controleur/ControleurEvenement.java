...
/**
 * Controleur pour la gestion des evenements
 * @author Groupe 24
 */
public class ControleurEvenement {
	...
	/**
	 * Constructeur <br>
	 * Initialise une liste et y ajoute les évènements  
	 */
	public ControleurEvenement() {
		...
		Date dt = cal.getTime();
		this.listeEvent.add( new Evenement(1, "Evenement 1", dt, "Toulouse", true));
	...
	public void demarrerControleurEvenement() {
		if (this.lambda == null)
		{
			...
			this.lambda.setLocationRelativeTo(null); //fenêtre centrée
